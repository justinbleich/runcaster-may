-- Database procedures for automated challenge management

-- 1. Create a configuration table to store challenge parameters
...
-- 2. Insert default configuration for weekly distance challenge
...
-- 3. Create stored procedure to calculate user distances for a challenge
...
-- 4. Create stored procedure to calculate rankings for a challenge
...
-- 5. Create stored procedure to create a new challenge
...
BEGIN
  ...
  IF NOT FOUND THEN
    RAISE EXCEPTION 'Challenge configuration for type % not found', challenge_type;
  END IF;
...
-- 6. Create main procedure to manage weekly challenges
